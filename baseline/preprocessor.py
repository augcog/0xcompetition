...
class Preprocessor:
    ...
    def remove_features(self, inference=False):
        ...
        self.df.drop(['Index', 'Address', ' ERC20 uniq sent token name',
                      ' ERC20 uniq rec token name',
                      ' ERC20 most sent token type',
                      ' ERC20_most_rec_token_type', ' ERC20 min val sent contract', ' ERC20 max val sent contract',
                      ' ERC20 avg val sent contract', 'min value sent to contract', 'max val sent to contract',
                      'avg value sent to contract', ' ERC20 avg time between sent tnx',
                      ' ERC20 avg time between rec tnx', ' ERC20 avg time between rec 2 tnx',
                      'total ether sent contracts', ' ERC20 avg time between contract tnx',
                      ' ERC20 total Ether sent contract', ' ERC20 uniq sent addr.1'], axis=1, inplace=True)
